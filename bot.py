    ...
    if provider in ("assemblyai", "aai"):
        ...
        return AssemblyAISTTService(
            ...
            connection_params=AssemblyAIConnectionParams(
                ...
                end_of_turn_confidence_threshold=float(os.getenv("AAI_EOT_CONFIDENCE_THRESHOLD", "0.8")),
                min_end_of_turn_silence_when_confident=int(os.getenv("AAI_EOT_MIN_SILENCE_MS", "700")),
                max_turn_silence=int(os.getenv("AAI_EOT_MAX_TURN_SILENCE_MS", "2400")),
            ),
            vad_force_turn_endpoint=False,
            should_interrupt=True,  # ← Silero/Daily handles interruptions, not AAI
        )
